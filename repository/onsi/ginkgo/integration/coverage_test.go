...
var _ = Describe("Coverage Specs", func() {
	...
	It("runs coverage analysis in series and in parallel", func() {
		...
		session = startGinkgo("./_fixtures/coverage_fixture", "-coverpkg=github.com/yyleeshine/mpquic/repository/onsi/ginkgo/integration/_fixtures/coverage_fixture,github.com/yyleeshine/mpquic/repository/onsi/ginkgo/integration/_fixtures/coverage_fixture/external_coverage_fixture")
		Eventually(session).Should(gexec.Exit(0))
		output = session.Out.Contents()
		Ω(output).Should(ContainSubstring("coverage: 71.4% of statements in github.com/yyleeshine/mpquic/repository/onsi/ginkgo/integration/_fixtures/coverage_fixture, github.com/yyleeshine/mpquic/repository/onsi/ginkgo/integration/_fixtures/coverage_fixture/external_coverage_fixture"))
		...
		Eventually(startGinkgo("./_fixtures/coverage_fixture", "-coverpkg=github.com/yyleeshine/mpquic/repository/onsi/ginkgo/integration/_fixtures/coverage_fixture,github.com/yyleeshine/mpquic/repository/onsi/ginkgo/integration/_fixtures/coverage_fixture/external_coverage_fixture", "-nodes=4")).Should(gexec.Exit(0))

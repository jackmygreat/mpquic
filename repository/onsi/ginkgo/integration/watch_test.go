...
var _ = Describe("Watch", func() {
	...
	BeforeEach(func() {
		...
		pathA = filepath.Join(rootPath, "src", "github.com/yyleeshine/mpquic/repository", "onsi", "A")
		pathB = filepath.Join(rootPath, "src", "github.com/yyleeshine/mpquic/repository", "onsi", "B")
		pathC = filepath.Join(rootPath, "src", "github.com/yyleeshine/mpquic/repository", "onsi", "C")
	...
	modifyCode := func(pkgToModify string) {
		modifyFile(filepath.Join(rootPath, "src", "github.com/yyleeshine/mpquic/repository", "onsi", pkgToModify, pkgToModify+".go"))
	}

	modifyJSON := func(pkgToModify string) {
		modifyFile(filepath.Join(rootPath, "src", "github.com/yyleeshine/mpquic/repository", "onsi", pkgToModify, pkgToModify+".json"))
	}

	modifyTest := func(pkgToModify string) {
		modifyFile(filepath.Join(rootPath, "src", "github.com/yyleeshine/mpquic/repository", "onsi", pkgToModify, pkgToModify+"_test.go"))
	}
	...
	Describe("when new test suite is added", func() {
		It("should start monitoring that test suite", func() {
			...
			pathD := filepath.Join(rootPath, "src", "github.com/yyleeshine/mpquic/repository", "onsi", "D")

...
import (
	...
	"github.com/yyleeshine/mpquic/repository/onsi/ginkgo/ginkgo/nodot"
)
...
import (
	...
	{{.GinkgoImport}}
	{{.GomegaImport}}
	"github.com/yyleeshine/mpquic/repository/sclevine/agouti"
)
...
func generateBootstrap(agouti, noDot, internal bool, customBootstrapFile string) {
	...
	data := bootstrapData{
		...
		GinkgoImport:  `. "github.com/yyleeshine/mpquic/repository/onsi/ginkgo"`,
		GomegaImport:  `. "github.com/yyleeshine/mpquic/repository/onsi/gomega"`,
	}

	if noDot {
		data.GinkgoImport = `"github.com/yyleeshine/mpquic/repository/onsi/ginkgo"`
		data.GomegaImport = `"github.com/yyleeshine/mpquic/repository/onsi/gomega"`
	}

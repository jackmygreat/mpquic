...
import (
	...
	"github.com/yyleeshine/mpquic/repository/x/text/collate"
...
`
	...
	copyExported("github.com/yyleeshine/mpquic/repository/x/net/idna")
...
func copyExported(p string) {
	copyPackage(
		...
		filepath.Join("..", filepath.FromSlash(p[len("github.com/yyleeshine/mpquic/repository/x"):])),
		"github.com/yyleeshine/mpquic/repository/x/text/internal/export/"+path.Base(p),
		p)
}

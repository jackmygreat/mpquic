...
import (
	...
	"github.com/yyleeshine/mpquic/repository/x/text/internal/catmsg"
...
var handle = catmsg.Register("github.com/yyleeshine/mpquic/repository/x/text/feature/plural:plural", execute)
